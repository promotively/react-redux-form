...
describe('components/form.js', () => {
  it('renders correctly with default form component.', () => {
    const renderer = ReactTestRenderer.create(<WrappedForm id={mockFormId} />);
  ...
  it('renders correctly with custom form component provided by the `component` prop.', () => {
    const renderer = ReactTestRenderer.create(<WrappedForm id={mockFormId} component={props => <form {...props} />} />);
    const container = renderer.root;
  ...
  it('renders correctly with custom form component provided by the render prop.', () => {
    const renderer = ReactTestRenderer.create(<WrappedForm id={mockFormId} render={props => <form {...props} />} />);
    const container = renderer.root;
