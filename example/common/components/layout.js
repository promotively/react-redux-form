...
export const Layout = props => {
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      <a
        href="https://github.com/promotively/react-redux-form"
        style={{
          backgroundImage:
      ...
      >
        <Alert type="warn">
          Tip: React Developer Tools, Redux Logger, Redux Dev Tools and Source Maps are all enabled in this example.
        </Alert>
      </div>
      <p>
      ...
      <div style={{ paddingTop: '5px', textAlign: 'right' }}>Promotively &copy; 2020</div>
    </div>
  );
};
